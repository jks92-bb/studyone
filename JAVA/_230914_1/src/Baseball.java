...
public class Baseball {
    public static void main(String[] args) {
        ...
        // 정답 3개
        // int answer1 을 선언하고 숫자 저장
        int answer1 = 1;
        // int answer2 을 선언하고 숫자 저장
        int answer2 = 3;
        // int answer3 을 선언하고 숫자 저장
        int answer3 = 5;
        // 스트라이크, 볼 판별.
        // int strike 를 선언하고 0을 저장.
        int strike = 0;
        // int ball 을 선언하고 0을 저장.
        int ball = 0;
        ...
        for (int i = 0; i < 9; i++) {
            ...
            //- strike++
            // 아니라면
            // - 만약 question3 == answer2 || question3 == answer1  이라면
            // - ball++
