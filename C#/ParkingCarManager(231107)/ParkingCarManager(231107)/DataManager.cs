...
namespace ParkingCarManager_231107_
{
    public class DataManager
    {
        ...
        {
            if (DBHelper.dt.Rows.Count == 0) //해당 주차공간이 없는 경우
            {
        ...
        public static void printLog(string contents)
        {
            ...
            // @"LogFolder\ParkiingHistory.txt" ,"LogFolder\\ParkiingHistory.txt" 둘중 하나쓰기.
            //true : append 옵션,  false 를 적거나 이 부분을 아예 안 적으면
            // 새로운 내용이 나올때만다 parkingHistory.tx에 덮어쓰기함
            // 즉 내용이 누적되지 않음.
