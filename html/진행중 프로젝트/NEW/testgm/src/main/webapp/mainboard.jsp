...
<body>
	...
	<img class="bestThumbnail"
		src="https://github.com/db-ung/web_pj/blob/main/%EC%9E%A1%EB%8F%99%EC%82%AC%EB%8B%88/%ED%99%94%EB%A9%B4%20%EC%BA%A1%EC%B2%98%202024-01-16%20151335.png?raw=true"
		alt="썸네일 이미지">

	<div>
		<img class="AD"
			src="https://github.com/db-ung/web_pj/blob/main/%EC%9E%A1%EB%8F%99%EC%82%AC%EB%8B%88/PS20102100902.jpg?raw=true"
			alt="광고 이미지">
	</div>

	<ol class="spotlight1">
		<a href="ppb1.do">인기 게시판1 보기</a>
	</ol>
	<ol class="spotlight2">
		<a href="ppb2.do">인기 게시판2 보기</a>
	</ol>

	<ol class="spotlight3">
		<a href="ppb3.do">인기 게시판3 보기</a>
	</ol>
	...
	<ol class="newList" id="newPostList">최신글
		<%
        // 세션에서 boardList 가져오기
    ...
    %>
                <li>
                    <strong><%= boardInfo.get("tag") %></strong>: <%= boardInfo.get("title") %>
                </li>
    <%
            }
        } else {
